...
import com.cjwwdev.shuttering.filters.ShutteringFilter
...
class DefaultOutageFilter @Inject()(val config: Configuration,
                                    val mat: Materializer) extends OutageFilter {
  override val appName: String = config.get[String]("appName")
}

trait OutageFilter extends ShutteringFilter[JsValue] {
